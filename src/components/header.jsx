...
import { Title, Link } from './texts.jsx';
    ...
    return (
        <>
            ...
            <nav className={menu_list}>
                <a className={menu_elt} href='#home'>
                    Home
                </a>
                <a className={menu_elt} href='#about-me'>
                    About Me
                </a>
                <a className={menu_elt} href='#skills'>
                    Skills
                </a>
                <a className={menu_elt} href='#projects'>
                    Projects
                </a>
                <a className={menu_elt} href='#contact-me'>
                    Contact Me
                </a>
            </nav>
        </>
